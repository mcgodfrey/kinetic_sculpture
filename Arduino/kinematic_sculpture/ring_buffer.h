...
extern "C" {
  ...
  static inline void RingBuffer_Insert_Fast(RingBuffer_t* Buffer, const uint8_t Data) ATTR_NON_NULL_PTR_ARG(1);
  static inline void RingBuffer_Insert_Fast(RingBuffer_t* Buffer, const uint8_t Data)
  {
    *Buffer->In = Data;
